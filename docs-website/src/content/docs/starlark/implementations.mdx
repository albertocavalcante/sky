...
func main() {
    ...
    globals, _ := starlark.ExecFile(thread, "config.star", nil, nil)
...
<Aside type="tip">
For Go projects needing advanced features, see [starlark-go-x](https://github.com/albertocavalcante/starlark-go-x) - an enhanced fork with additional builtins.
</Aside>
