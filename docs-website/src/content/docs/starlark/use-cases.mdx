...
|----------|------|----------|
| **Build Systems** | [Bazel](/starlark/build-systems-comparison/), [Buck2](/starlark/build-systems-comparison/) | Monorepo builds, hermetic compilation |
| **Config Generation** | [Skycfg](/starlark/skycfg-deep-dive/), [ytt](/starlark/ytt-deep-dive/) | Kubernetes, Envoy, Terraform configs |
