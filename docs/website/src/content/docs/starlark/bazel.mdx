...
<Aside type="note">
Bazel uses **starlark-java** (`net.starlark.java`), its own Java implementation of Starlark. This is *not* the same as starlark-go, which is used by other tools like Tilt and Copybara.
</Aside>
