...
description: Real-world Starlark applications beyond build systems
---
...
<CardGrid>
  <LinkCard
    title="Bazel vs Buck2"
    href="/sky/starlark/build-systems-comparison/"
    description="In-depth comparison of the two major Starlark build systems"
  />
  <LinkCard
    title="Skycfg (Stripe)"
    href="/sky/starlark/skycfg-deep-dive/"
    description="Type-safe Protobuf configuration with Starlark"
  />
  <LinkCard
    title="ytt (Carvel)"
    href="/sky/starlark/ytt-deep-dive/"
    description="Structural YAML templating for Kubernetes"
  />
  <LinkCard
    title="Aspect CLI & AXL"
    href="/sky/starlark/aspect-cli-axl/"
    description="Extending Bazel with custom Starlark commands"
  />
</CardGrid>
...
|----------|------|----------|
| **Build Systems** | [Bazel](/sky/starlark/build-systems-comparison/), [Buck2](/sky/starlark/build-systems-comparison/) | Monorepo builds, hermetic compilation |
| **Config Generation** | [Skycfg](/sky/starlark/skycfg-deep-dive/), [ytt](/sky/starlark/ytt-deep-dive/) | Kubernetes, Envoy, Terraform configs |
