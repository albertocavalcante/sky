...
<Aside type="note">
Copybara uses [**starlark-java**](https://github.com/bazelbuild/bazel/tree/master/src/main/java/net/starlark/java) (`net.starlark.java`), the same Starlark implementation used by Bazel. This ensures compatibility with Bazel's Starlark semantics.

*Source: [RemoteFileModule.java](https://github.com/google/copybara/blob/30246465ec209685ba31ecccfe49c9f1ac3b243f/java/com/google/copybara/remotefile/RemoteFileModule.java#L17)*
</Aside>
