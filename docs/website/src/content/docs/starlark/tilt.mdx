...
<Aside type="note">
Tilt uses [**starlark-go**](https://github.com/google/starlark-go) (`go.starlark.net`), the canonical Go implementation of Starlark. This is the same implementation used by Copybara, Skycfg, and other Go-based tools.
